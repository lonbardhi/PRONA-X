...
const sellerLeadCopy = {
  sq: {
    eyebrow: "Leads shitësish",
    title: "Procesi i Leads Shitësish",
    subtitle:
      "Kualifiko pronarët, përgatit dorëzimin e listimit dhe zhvendos shitësit e pranuar në inventarin e shitjeve PRONA X.",
    newLeads: "Leads të reja",
    followUp: "Ndjekje",
    converted: "Konvertuar",
    emptyTitle: "Ende nuk ka leads shitësish",
    emptyBody:
      "Shitësit e pranuar mund të kalojnë në një listim manual prone derisa të shtohet databaza e dedikuar e leads.",
    addProperty: "Shto pronë",
    salesInventory: "Inventari i shitjeve",
    handoffTitle: "Dorëzim në shitje",
    handoffSubtitle: "Nga lead në listim aktiv",
    handoffSteps: [
      "Lead-i i shitësit u kualifikua",
      "U krijua rekordi i pronës",
      "Media dhe dokumentet u përgatitën",
      "Rishikimi nga menaxheri u përfundua",
      "Listimi u publikua për shitje",
    ],
  },
  en: {
    eyebrow: "Seller Leads",
    title: "Seller Lead Pipeline",
    subtitle:
      "Qualify owners, prepare listing handoff, and move accepted sellers into the PRONA X sales inventory.",
    newLeads: "New Leads",
    followUp: "Follow-up",
    converted: "Converted",
    emptyTitle: "No seller leads yet",
    emptyBody:
      "Accepted sellers can be moved into a manual property listing while the dedicated lead database is added.",
    addProperty: "Add property",
    salesInventory: "Sales inventory",
    handoffTitle: "Sales handoff",
    handoffSubtitle: "Lead to active listing",
    handoffSteps: [
...
export default async function SellerLeadsPage() {
  ...
  const copy = sellerLeadCopy[locale];
          ...
          <aside className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm text-slate-500">{copy.handoffSubtitle}</p>
              </div>
            </div>
            <ol className="mt-5 grid gap-3 text-sm text-slate-600">
              {copy.handoffSteps.map((item, index) => (
                <li
