...
import { generateSmartKitQualityCheck } from "@/modules/smart-listing-kit/smart-listing-kit.service";
import {
...
export async function POST(
  ...
  try {
    const data = await generateSmartKitQualityCheck({
    ...
    return smartListingKitApiError(error, "Could not check listing quality.");
  }
}
